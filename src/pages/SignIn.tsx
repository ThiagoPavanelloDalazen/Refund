...
export function SignIn() {
    ...
    function onSubmit(e: FormEvent<HTMLFormElement>) {
        e.preventDefault()
        setIsLoading(true)
        // use the state values to avoid unused-variable errors
    ...
    return (
        <form onSubmit={onSubmit} className="w-full flex flex-col gap-4">
            ...
            <Link to="/signup" className="text-sm font-semibold text-gray-100 mt-10 mb-4 text-center hover:text-green-800 transition easy-linear">Criar conta</Link>
